            ...
            <div id="carouselID" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active"
                         style="background-image: url(http://bmnkita.id/amara/assets/frontend/images/slider/slide-1.jpeg)">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown mb-0">AMARA</h2>
                                <p class="lead animate__animated animate__fadeInUp mb-2">Aplikasi Manajemen Rapat</p>
                                <p class="animate__animated animate__fadeInUp">Mempermudah unit kerja dalam pemesanan
                                    ruang rapat, update informasi ketersediaan ruang rapat dan kelengkapannya serta real
                                    time jadwal pelaksanaan rapat di lingkungan sekretariat jenderal MPR RI</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item"
                         style="background-image: url(http://bmnkita.id/amara/assets/frontend/images/slider/slide-2.jpeg)">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown">Presensi Online</h2>
                                <p class="animate__animated animate__fadeInUp">AMARA juga memiliki fitur presensi online
                                    untuk memudahkan peserta rapat dalam melakukan presensi kehadiran saat mengikuti
                                    rapat</p>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item"
                         style="background-image: url(http://bmnkita.id/amara/assets/frontend/images/slider/slide-3.jpeg)">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown">Terintegrasi</h2>
                                <p class="animate__animated animate__fadeInUp">AMARA kini telah terintegrasi dengan
                                    berbagai aplikasi lain di smartphone Anda sehingga semakin memudahkan Anda dalam
                                    mengakses informasi jadwal ruangan dan melakukan presensi online</p>
                            </div>
                        </div>
                    </div>
                </div>
